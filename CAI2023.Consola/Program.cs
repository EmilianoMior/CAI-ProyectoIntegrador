    ...
    namespace CAI2023.Consola
    {
        public class Program
        {
            ...
            public static void BajaDeUsuario()
            {
        ...
        public static void Altaproveedor()
        {
          ...
          public static void ModificacionProveedor()
            {
                Console.WriteLine("a completar");
            }
            ...
            public static void ModificacionProductos()
            {
                Console.WriteLine("a completar");
            }
            ...
            public static void Reportesvtasporvendedor()
            {
                Console.WriteLine("a completar");
            }
            public static void Reporteproductosporcat()
            {
                Console.WriteLine("a completar");
            }
